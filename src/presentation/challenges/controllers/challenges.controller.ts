...
export class ChallengeController {
    ...
    @Patch("/publish/:id")
    @ApiOperation({ summary: "Publish Challenge" })
    @ApiOkResponse({ description: "The challenge was published correctly" })
    async publishChallenge(@Param("id") id: string) {
        return await this.updateState.execute(id, 'Published');
    }

    @Patch("/archive/:id")
    @ApiOperation({ summary: "Archive Challenge" })
    @ApiOkResponse({ description: "The challenge was archived correctly" })
    async archiveChallenge(@Param("id") id: string) {
        return await this.updateState.execute(id, 'Archived');
    }
}